package ru.clevertec.testWork.common;
...
public class AcceptedMediaTypesTest {
    ...
    Collection<DynamicTest> createControllerTests(){
        ...
        Set<BeanDefinition> definitions = scanner.findCandidateComponents("ru.clevertec");
            ...
            for (Method method : controllerClazz.getMethods()){
                if (method.isAnnotationPresent(PostMapping.class)){
                    ...
                    for (MediaType mediaType : SUPPORTED_MEDIA_TYPES){
                        generatedTests.add(DynamicTest.dynamicTest(getDisplayName(mapping.value()[0],
                                methodMapping, mediaType),
